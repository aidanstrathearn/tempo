...
class sptensor:
    ...
    def __init__(self,
        ...
        if (shape is not None and not tools.tt_sizecheck(shape)):
        ...
        if(subs.size == 0):
            ...
            newval = numpy.ndarray([len(newsub), 1], dtype = self.dtype);
            newval.fill(0);
    ...
    def totensor(self):
        ...
        temp = numpy.ndarray(self.shape, dtype =self.dtype);
        temp.fill(0);
